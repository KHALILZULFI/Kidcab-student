...
const EditLastName = (props) => {
    ...
    const check_valid = () => {
        if (last_name) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your last name');
        }
    }
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Enter your last name</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>You need enter your last name</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
